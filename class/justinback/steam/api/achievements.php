 ...
 */
class achievements implements \justinback\steam\interfaces\IAchievements {
    ...
    public function GetPlayerAchievements() {
        ...
        if ($CURLResponseCode != 200) {
            if ($CURLResponseCode == 400) {
                throw new \justinback\steam\exceptions\SteamIDInvalidException("The SteamID is invalid!");
            }
        ...
        throw new \justinback\steam\exceptions\SteamEmptyException("This user has no unlocked achievements!");
    }
    ...
    public function GetPlayerAchievementsLocked() {
        ...
        throw new \justinback\steam\exceptions\SteamEmptyException("This user has no locked achievements!");
    }
    ...
    public function GetAchievementDetails($sApiname) {
        ...
        if ($CURLResponseCode != 200) {
            if ($CURLResponseCode == 400) {
                throw new \justinback\steam\exceptions\SteamRequestParameterException("The API Name entered is invalid!");
            }
            if ($CURLResponseCode == 401) {
                throw new \justinback\steam\exceptions\SteamException("App ID or API Key is invalid.");
            }
    ...
    public function LockAchievement($sApiname) {
        ...
        if(isset($CURLResponse->response->error)){
            throw new \justinback\steam\exceptions\SteamRequestParameterException($CURLResponse->response->error);
        }
        throw new \justinback\steam\exceptions\SteamRequestParameterException("The API Name entered is invalid");
    }
    ...
    public function UnlockAchievement($sApiname) {
        ...
        throw new \justinback\steam\exceptions\SteamEmptyException("The API Name entered is invalid!");
    }
