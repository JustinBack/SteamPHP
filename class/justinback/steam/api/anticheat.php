 ...
 */
class anticheat implements \justinback\steam\interfaces\IAnticheat {
    ...
    public function RequestPlayerGameBan($sCheatDescription, $iDuration, $bDelayBan = false) {
        ...
        if ($CURLResponseCode != 200) {
            if ($CURLResponseCode == 400) {
                throw new \justinback\steam\exceptions\SteamRequestParameterException("The Duration or Report ID entered is invalid!");
            }
