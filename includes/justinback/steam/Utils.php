 ...
 */
class Utils implements interfaces\IUtils {
    ...
    public static function ConstructApiUris(bool $bPublic, string $sApiInterface, string $sApiMethod, string $sApiMethodVersion, string $sGetParameters = null): string {
        return ($bPublic ? \justinback\SteamPHP::PUBLIC_API_ROOT : \justinback\SteamPHP::PARTNER_API_ROOT)
                . '/'
                . $sApiInterface
                . '/'
                . $sApiMethod
                ...
                . $sApiMethodVersion
                . '/'
                . ($sGetParameters !== null ? "?$sGetParameters" : null);
    }
